<!-- resources/views/components/skeleton/reports-skeleton.blade.php -->
    ...
    <div x-show="loading" x-transition:leave="transition-opacity duration-300" x-transition:leave-start="opacity-100"
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex items-center gap-2 mt-3 sm:mt-0">
                <div class="h-10 w-40 bg-gray-200 dark:bg-zinc-700 rounded animate-pulse"></div>
        ...
        <div class="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
            @for ($i = 0; $i < 4; $i++)
                <div
                    ...
                    <div class="mt-3">
                        <div class="h-7 w-20 bg-gray-200 dark:bg-zinc-700 rounded animate-pulse"></div>
        ...
        <!-- Graph -->
        <div
            class="mt-4 bg-white dark:bg-zinc-900 rounded-md shadow-sm border border-gray-200 dark:border-zinc-800/60 p-4 h-64">
                        ...
                        <thead>
                            <tr class="border-b border-gray-200 dark:border-zinc-800">
                                ...
                                <th class="pb-3 pl-4 text-right">
                                    <div class="h-4 w-20 bg-gray-200 dark:bg-zinc-700 rounded animate-pulse ml-auto">
                                    </div>
                                </th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-100 dark:divide-zinc-800/50">
                            @for ($i = 0; $i < 6; $i++)
                                <tr>
                                    ...
                                    <td class="py-3 px-4">
                                        <div
                                            class="h-4 w-12 bg-gray-200 dark:bg-zinc-700 rounded animate-pulse mx-auto">
                                        </div>
                                    </td>
                                    <td class="py-3 px-4">
                                        <div
